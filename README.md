...
# CODESIGMAX.COM
FREE SUBDOMAIN REGISTRY

</div>

## Cara Mendaftarkannya
1. Fork repository ini
2. Tambahkan file JSON di folder `domains/nama-kamu.json`
    ### CONTOH
    ```json
...
## NOTE
- Jika tidak mematuhi aturan dan ToS maka request pull akan saya batalkan!!
- Server dengan A Record yang mengalami down tim project KDMI Tidak akan tanggung jawab!

## SOCIAL
- [Telegram Group](https://t.me/org_kdmi)
- [Telegram Channel](https://t.me/kdmi_id)